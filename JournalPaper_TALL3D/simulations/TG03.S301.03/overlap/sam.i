...
[GlobalParams]
  ...
  global_init_V = 0.2           # Global initial fluid velocity
...
[Functions]
  [time_stepper]
    ...
    x = '0     90   100  2500  2600  4900 5000  20000'
#    y = '0.1  0.1  0.05  0.05  0.1  0.1  0.1    0.1'
...
#    y = '1  1  1  1  1  1  1  1'
  ...
  [./pump_head_fn]
    type         = PiecewiseLinear
    x            = '-10000  100    102   10000'
    y            = '1.0     1.0  0.0   0.0'
    scale_factor = ${P_HEAD}
  [../]
  [./pump_heating_source] # zero when pump is not running
    type         = PiecewiseLinear
    x            = '-10000  100   102  10000'
    y            = '1.0     1.0  0.0   0.0'
    scale_factor = ${Q_PM}
...
#  scheme = implicit-euler # try to run
  line_search = 'none'
