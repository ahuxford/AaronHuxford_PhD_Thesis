...
[Functions]
  [./time_stepper]
    ...
    x    = '-5000 -4990  -4900 -4800 -4000 -3990  0.0  0.1  5.0  3000'
    y    = '0.1     0.5    2.0   5.0   5.0  10.0  10.0 0.1  1.0   1.0' #dt2
#    y    = '0.1     0.5    2.0   5.0   5.0  10.0  10.0 0.1  2.0   2.0' #dt1
#    y    = '0.1     0.5    2.0   5.0   5.0  10.0  10.0 0.1  5.0   5.0' #dt1
  [../]
  [./pump_head_fn]
    type         = PiecewiseLinear
    x            = '-10000  0    2   10000'
  ...
  [./pump_heating_source]
    type         = PiecewiseLinear
    x            = '-10000  0    2  10000'
    y            = '1.0    1.0  1.0  1.0' # keep heat source
    scale_factor = ${Q_PM}
  [../]
  [./SS316-k]
    type = PiecewiseLinear
...
#    Desired_mass_flow_rate = 3.3
  ...
  [./secondary-inlet]
    ...
    m_bc  = -0.25
#    v_bc  = ${init_Vsecond}
    T_bc  = 359.15 # value shouldnt matter
  [../]
  ...
  [./secondary-outlet]
    ...
    input = 'S3(in)'
    eos   = Oil
    T_bc  = 359.15 # set based on input oil temperature
    p_bc  = 1.3e5
  [../]
[]
[Postprocessors]
