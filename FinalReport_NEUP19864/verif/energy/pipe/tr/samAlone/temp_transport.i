...
[Executioner]
  ...
  dtmin = 0.001                       # The allowed minimum time step size
  num_steps = 2000 
  ...
  nl_rel_tol = 1e-12                   # Relative nonlinear tolerance for each Newton solve
  nl_abs_tol = 1e-12                   # Relative nonlinear tolerance for each Newton solve
  nl_max_its = 50                     # Number of nonlinear iterations for each Newton solve

  l_tol = 1e-12                        # Relative linear tolerance for each Krylov solve
